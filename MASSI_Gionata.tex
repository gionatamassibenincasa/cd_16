...
\mybullet Un sistema di caching: dopo la prima richiesta le query non si propagano. \uncover<2>{\alert{Analogie con: tabelle di lookup e tecniche di programmazione tipo momoize, organizzazione della memoria\ldots{}}}
\end{block}
\end{frame}
